...
<body>
    ...
    <button id="btn-change-image">換圖 大頭照為生活照</button>
    <button id="btn-fade">控制圖片的淡入、淡出</button>
    <br>
    <a href="#" id="index.html" target="_blank">超連結1: 顯示本題答案的原始 HTML 檔</a>
    <br>
    <a href="#" id="selfie.jpg" target="_blank">超連結2: 顯示本題答案的原始 JS 檔</a>
</body>
</html>
